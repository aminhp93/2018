...
class CurrentPrice extends React.Component {
    ...
    filter(condition) {
        ...
        if (condition === 'RSI_60') {
            ...
            var BasicEPSFilterComponent = this.gridApi.getFilterInstance("MarketCapitalization");
            BasicEPSFilterComponent.setModel({
                type: "greaterThan",
                filter: 300000000000,
                filterTo: null
